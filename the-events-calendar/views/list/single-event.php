...
<div class="tribe-events-event-meta <?php echo $has_venue . $has_venue_address; ?>">
	...
	<?php if ( $venue_details ) : ?>
		<!-- Venue Display Info -->
		<div class="tribe-events-venue-details list-view">
...
<div class="tribe-events-list-event-description tribe-events-content description entry-summary">
	<?php the_excerpt() ?>
    <div class="pad-half-t">
	<a href="<?php echo tribe_get_event_link() ?>" class="btn btn-info" rel="bookmark"><i class="fa fa-arrow-right"></i>Read More </a></div>
