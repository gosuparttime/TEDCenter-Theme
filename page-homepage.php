  ...
  <div id="main" class="clearfix col-md-11 alpha" role="main">
    <div id="myCarousel" class="carousel slide"> 
      ...
      <ol class="carousel-indicators">
        <?php
        $myposts = get_field('featured_slide', 'option');
		$paginate = 0;
    ...
    <article id="post-<?php the_ID(); ?>" <?php post_class('clearfix'); ?> role="article">
      <header> </header>
      <section class="row-fluid post_content"> </section>
      <!-- end article header -->
      ...
      <div class="row">
        <div class="col-sm-8 widget">
          <div class="well">
            ...
            <a class="btn btn-info btn-block" href="/programs/overview-of-programs/">View All Programs <i class="fa fa-arrow-right"></i></a> </div>
        </div>
        <div class="col-sm-7 widget">
          <?php //display_events('5', '3'); ?>
          <h3>Upcoming Events</h3>
          <?php echo do_shortcode('[gcal id="914"]'); ?>
          <a class="btn btn-info btn-block" href="/news-events/calendar-of-events/">View All Events <i class="fa fa-arrow-right"></i></a>
        </div>
      </div>
    </aside>
