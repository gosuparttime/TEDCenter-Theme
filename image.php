			...
			<div id="content" class="clearfix row">
				...
				<div id="main" class="span8 clearfix" role="main">
					...
					<article id="post-<?php the_ID(); ?>" <?php post_class('clearfix'); ?> role="article" itemscope itemtype="http://schema.org/BlogPosting">
						...
						<header> 
							...
							<p class="meta"><?php _e("Posted", "ted-theme"); ?> <time datetime="<?php echo the_time('Y-m-j'); ?>" pubdate><?php the_date(); ?></time> <?php _e("by", "ted-theme"); ?> <?php the_author_posts_link(); ?>.</p>
					...
					<article id="post-not-found">
					    <header>
					    	<h1><?php _e("Not Found", "ted-theme"); ?></h1>
					    </header>
					    <section class="post_content">
					    	<p><?php _e("Sorry, but the requested resource was not found on this site.", "ted-theme"); ?></p>
					    </section>
					    <footer>
					    </footer>
					</article>
				...
				<div id="sidebar1" class="span4 fluid-sidebar sidebar" role="complementary">
					...
					<div class="well">
						...
						<h3><?php _e("Image metadata","ted-theme"); ?></h3>
					...
					// Start to display EXIF and IPTC data of digital photograph
					       if ( $imgmeta['image_meta']['created_timestamp'] ) { 
					           echo __("Date Taken","ted-theme") . ": " . date("d-M-Y H:i:s", $imgmeta['image_meta']['created_timestamp'])."<br />"; }
					       if ( $imgmeta['image_meta']['copyright'] ) { 
					           echo __("Copyright","ted-theme") . ": " . $imgmeta['image_meta']['copyright']."<br />"; }
					       if ( $imgmeta['image_meta']['credit'] ) { 
					           echo __("Credit","ted-theme") . ": " . $imgmeta['image_meta']['credit']."<br />"; }
					       if ( $imgmeta['image_meta']['title'] ) { 
					           echo __("Title","ted-theme") . ": " . $imgmeta['image_meta']['title']."<br />"; }
					       if ( $imgmeta['image_meta']['caption'] ) { 
					           echo __("Caption","ted-theme") . ": " . $imgmeta['image_meta']['caption']."<br />"; }
					       if ( $imgmeta['image_meta']['camera'] ) { 
					           echo __("Camera","ted-theme") . ": " . $imgmeta['image_meta']['camera']."<br />"; }
					       if ( $imgmeta['image_meta']['focal_length'] ) { 
					           echo __("Focal Length","ted-theme") . ": " . $imgmeta['image_meta']['focal_length']."mm<br />"; }
					       if ( $imgmeta['image_meta']['aperture'] ) { 
					           echo __("Aperture","ted-theme") . ": f/" . $imgmeta['image_meta']['aperture']."<br />"; }
					       if ( $imgmeta['image_meta']['iso'] ) { 
					           echo __("ISO","ted-theme") . ": " . $imgmeta['image_meta']['iso']."<br />"; }
					       if ( $pshutter ) { 
					           echo __("Shutter Speed","ted-theme") . ": " . $pshutter . "<br />"; }
					   ?>
					</div>
