...
load_theme_textdomain( 'ted-theme', TEMPLATEPATH.'/languages' );
$locale = get_locale();
...
function bones_theme_support() {
	...
	register_nav_menus(                      // wp3+ menus
		array( 
			'utility_nav' => 'Utility Links', // secondary nav in footer
			'main_nav' => 'The Main Menu',   // main nav in header
			'footer_links' => 'Footer Links', // secondary nav in footer
			'site_links' => 'Site Links', // secondary nav in footer
		)
	);	
}
...
function bones_utility_links() { 
	// display the wp3 menu if available
    wp_nav_menu(
    	array(
    		'menu' => 'utility-navigation', /* menu name */
			'menu_class' => 'menu',
	   		'theme_location' => 'utility-navigation', /* where in the theme it's assigned */
    		'container_class' => 'utility-links clearfix', /* container class */
    		'fallback_cb' => 'utility_links_fallback', /* menu fallback */
			'container'       => 'nav',
			'after'	=> '<li class="bull">&#8226;</li>',
			//'walker' => new Walker_Nav_Menu()
    	)
	);
}
function bones_site_links() { 
	// display the wp3 menu if available
    wp_nav_menu(
    	array(
    		'menu' => 'site_links', /* menu name */
    		'theme_location' => 'site_links', /* where in the theme it's assigned */
    		'container_class' => 'footer-links clearfix', /* container class */
    		'fallback_cb' => 'bones_footer_links_fallback', /* menu fallback */
			//'walker' => new Walker_Nav_Menu()
    	)
...
// this is the fallback for footer menu
function utility_links_fallback() { 
	/* you can put a default here if you like */ 
}
