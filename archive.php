...
<div id="content" class="col-md-12">
  <div class="white-bg row">
    <div class="page-header">
      <?php if (is_category()) { ?>
      <h1 class="page-title">
        <?php _e("Posts Categorized:", "ted-theme"); ?>
        
        <?php single_cat_title(); ?>
      </h1>
      <?php } elseif (is_tag()) { ?>
      <h1 class="page-title">
        <?php _e("Posts Tagged:", "ted-theme"); ?>
        
        <?php single_tag_title(); ?>
      </h1>
      <?php } elseif (is_author()) { ?>
      <h1 class="page-title">
        <?php _e("Posts By:", "ted-theme"); ?>
        
        <?php get_the_author_meta('display_name'); ?>
      </h1>
      <?php } elseif (is_day()) { ?>
      <h1 class="page-title">
        <?php _e("Daily Archives:", "ted-theme"); ?>
        
        <?php the_time('l, F j, Y'); ?>
      </h1>
      <?php } elseif (is_month()) { ?>
      <h1 class="page-title">
        <?php _e("Monthly Archives:", "ted-theme"); ?>
        :
        <?php the_time('F Y'); ?>
      </h1>
      <?php } elseif (is_year()) { ?>
      <h1 class="page-title">
        <?php _e("Yearly Archives:", "ted-theme"); ?>
        :
        <?php the_time('Y'); ?>
      </h1>
      <?php } ?>
    ...
    <article id="post-not-found">
      <header>
        <h1>
          <?php _e("No Posts Yet", "ted-theme"); ?>
        </h1>
      </header>
      <section class="post_content">
        <p>
          <?php _e("Sorry, What you were looking for is not here.", "ted-theme"); ?>
        </p>
      </section>
      <footer> </footer>
    </article>
